...
::alert{type="warning"}
⚠️ The module does not support Nuxt v2 or bridge.
::
...
To quickly add the recommended Schema.org to all pages, you can make use [Runtime Inferences](/guide/how-it-works.html#runtime-inferences).
