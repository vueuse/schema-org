    ...
    <div class="w-full px-7 md:px-15 xl:flex items-center justify-between md:(my-10 pb-20) my-7 pb-10">
      <div class="flex flex-col items-left xl:pr-20">
        <h1 class="md:(leading-22 text-6xl w-750px text-left) leading-14 font-bold text-3xl font-500 mt-0 mb-5">
          Simple and <span class="border-b-5 border-blue-400">automated</span> Schema.org for
          <span class="whitespace-nowrap"><img src="/google-logo.svg" height="55" class="md:h-60px h-40px inline mr-4 mb-1 md:mb-2"><a href="https://github.com/GoogleChrome/lighthouse" target="_blank" class="text-inherit">Google Rich Results</a></span>
          - for Vue.js.
        </h1>
        <div class="mb-5">
      ...
      <div class="w-960px mx-auto relative w-full group max-w-full h-auto xl:mt-0 mt-10">
        <img width="200" src="https://developers.google.com/search/docs/advanced/structured-data/images/reviews04.png" class=" w-700px h-full object-cover" />
        <img src="https://developers.google.com/search/docs/advanced/structured-data/images/logo01.png" class="absolute top-0 w-400px">
      </div>
    </div>
